export const EXTENSION_PUBLIC_REPOSITORY_URL =
  'https://github.com/oliveiraD4vi/nbr-17225-guard-mirror'

export const EXTENSION_ISSUES_URL = `${EXTENSION_PUBLIC_REPOSITORY_URL}/issues`

export const LANDING_PAGE_URL = 'https://guardiaonbr17225.com.br'
